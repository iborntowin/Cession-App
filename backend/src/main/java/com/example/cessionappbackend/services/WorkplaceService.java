...
public class WorkplaceService {
    ...
    public WorkplaceDTO createWorkplace(WorkplaceDTO workplaceDto) {
        ...
        // Publish data change event for workplace creation (affects client data)
        eventPublisher.publishEvent(new DataChangeEvent(this, "Workplace", "CREATE", savedWorkplace.getId()));
    ...
    public void deleteWorkplace(UUID id) {
        ...
        // Publish data change event for workplace deletion (affects client data)
        eventPublisher.publishEvent(new DataChangeEvent(this, "Workplace", "DELETE", id));
    }
} 