...
public class DocumentService {
    ...
    public DocumentDTO uploadClientDocument(UUID clientId, Integer clientNumber, String documentType, MultipartFile file) throws IOException {
        ...
        // Publish data change event for document creation
        eventPublisher.publishEvent(new DataChangeEvent(this, "Document", "CREATE", savedDocument.getId()));
    ...
    public DocumentDTO uploadCessionDocument(UUID cessionId, MultipartFile file) throws IOException {
        ...
        // Publish data change event for cession document creation
        eventPublisher.publishEvent(new DataChangeEvent(this, "Document", "CREATE", savedDocument.getId()));
    ...
    public boolean deleteDocument(UUID id) {
        ...
        if (documentOpt.isPresent()) {
            ...
            try {
                ...
                // Publish data change event for document deletion
                eventPublisher.publishEvent(new DataChangeEvent(this, "Document", "DELETE", id));
