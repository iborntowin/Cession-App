...
public class JobService {
    ...
    public JobDTO createJob(JobDTO jobDto) {
        ...
        // Publish data change event for job creation (affects client data)
        eventPublisher.publishEvent(new DataChangeEvent(this, "Job", "CREATE", savedJob.getId()));
    ...
    public Optional<JobDTO> updateJob(UUID id, JobDTO jobDto) {
        ...
        // Publish data change event for job update (affects client data)
        eventPublisher.publishEvent(new DataChangeEvent(this, "Job", "UPDATE", updatedJob.getId()));
    ...
    public void deleteJob(UUID id) {
        ...
        // Publish data change event for job deletion (affects client data)
        eventPublisher.publishEvent(new DataChangeEvent(this, "Job", "DELETE", id));
    }
} 