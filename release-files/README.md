...
1. **Cession-Management-App_1.1.15_x64_en-US.msi.zip** (65.12 MB)
   - MSI installer compressed for GitHub release
   - **REQUIRED for auto-update functionality**
   - **NOTE:** GitHub will rename to: `Cession-Management-App_1.1.15_x64_en-US.msi.zip`

2. **latest.json** (< 1 KB)
   - Update manifest file
   - **REQUIRED for auto-update functionality**

3. **Cession Management App_1.1.15_x64-setup.exe**
   - NSIS installer (alternative to MSI)
   - Optional, for users who prefer EXE installers
   - **NOTE:** GitHub will rename to: `Cession.Management.App_1.1.15_x64-setup.exe`


## ⚠️ IMPORTANT: GitHub Filename Convention
GitHub automatically converts **spaces to dots** in uploaded filenames:
- Upload: `Cession-Management-App_1.1.15_x64_en-US.msi.zip`
- Actual URL: `Cession-Management-App_1.1.15_x64_en-US.msi.zip`
- Upload: `Cession Management App_1.1.15_x64-setup.exe`
- Actual URL: `Cession.Management.App_1.1.15_x64-setup.exe`
...
- ✅ latest.json
- ⚪ Cession Management App_1.1.15_x64-setup.exe (optional)

### Step 3: Publish
- Click **"Publish release"**
- Verify files are accessible at:
  - ZIP: https://github.com/iborntowin/Cession-App/releases/download/v1.1.15/Cession-Management-App_1.1.15_x64_en-US.msi.zip
  - JSON: https://github.com/iborntowin/Cession-App/releases/latest/download/latest.json
  - NSIS: https://github.com/iborntowin/Cession-App/releases/download/v1.1.15/Cession.Management.App_1.1.15_x64-setup.exe

## ✅ Verification

After publishing, test the update:
1. Install previous version (v1.1.14)
2. Open app → Settings → "Check for Updates"
3. Should show: "Update available: 1.1.15"
4. Click "Yes" to install
5. App downloads, installs, and restarts to v1.1.15
...
- **v1.1.15** (2025-11-08): Bug fixes and improvements
- **v1.1.14**: Previous version
