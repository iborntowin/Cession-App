...
1. **Cession-Management-App_1.0.42_x64_en-US.msi.zip** (64.18 MB)
   - MSI installer compressed for GitHub release
   - **REQUIRED for auto-update functionality**
   - **NOTE:** GitHub will rename to: `Cession-Management-App_1.0.42_x64_en-US.msi.zip`

2. **latest.json** (< 1 KB)
   - Update manifest file
   - **REQUIRED for auto-update functionality**

3. **Cession Management App_1.0.42_x64-setup.exe**
   - NSIS installer (alternative to MSI)
   - Optional, for users who prefer EXE installers
   - **NOTE:** GitHub will rename to: `Cession.Management.App_1.0.42_x64-setup.exe`


## ⚠️ IMPORTANT: GitHub Filename Convention
GitHub automatically converts **spaces to dots** in uploaded filenames:
- Upload: `Cession-Management-App_1.0.42_x64_en-US.msi.zip`
- Actual URL: `Cession-Management-App_1.0.42_x64_en-US.msi.zip`
- Upload: `Cession Management App_1.0.42_x64-setup.exe`
- Actual URL: `Cession.Management.App_1.0.42_x64-setup.exe`
...
2. Tag version: **v1.0.42**
3. Release title: **Version 1.0.42**
4. Description:
```
...
- ✅ Cession-Management-App_1.0.42_x64_en-US.msi.zip
- ✅ latest.json
- ⚪ Cession Management App_1.0.42_x64-setup.exe (optional)

### Step 3: Publish
- Click **"Publish release"**
- Verify files are accessible at:
  - ZIP: https://github.com/iborntowin/Cession-App/releases/download/v1.0.42/Cession-Management-App_1.0.42_x64_en-US.msi.zip
  - JSON: https://github.com/iborntowin/Cession-App/releases/latest/download/latest.json
  - NSIS: https://github.com/iborntowin/Cession-App/releases/download/v1.0.42/Cession.Management.App_1.0.42_x64-setup.exe

## ✅ Verification

After publishing, test the update:
1. Install previous version (v1.0.41)
2. Open app → Settings → "Check for Updates"
3. Should show: "Update available: 1.0.42"
4. Click "Yes" to install
5. App downloads, installs, and restarts to v1.0.42
...
- **v1.0.42** (2025-11-01): Bug fixes and improvements
- **v1.0.41**: Previous version
...
**Built on:** 11/1/2025, 12:01:24 PM
