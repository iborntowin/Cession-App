...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-5 gap-6">
  ...
  <div class="group bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-2xl border border-white/20 hover:bg-white/90 transition-all duration-300 hover:scale-105 hover:-translate-y-1">
    <div class="flex items-start justify-between">
      <div class="w-14 h-14 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
  ...
  <div class="group bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-2xl border border-white/20 hover:bg-white/90 transition-all duration-300 hover:scale-105 hover:-translate-y-1">
    <div class="flex items-start justify-between">
      <div class="w-14 h-14 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  <div class="group bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-2xl border border-white/20 hover:bg-white/90 transition-all duration-300 hover:scale-105 hover:-translate-y-1">
    <div class="flex items-start justify-between">
      <div class="w-14 h-14 bg-gradient-to-r from-purple-500 to-pink-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  <div class="group bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-2xl border border-white/20 hover:bg-white/90 transition-all duration-300 hover:scale-105 hover:-translate-y-1">
    <div class="flex items-start justify-between">
      <div class="w-14 h-14 bg-gradient-to-r {getHealthColor(systemHealth)} rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
