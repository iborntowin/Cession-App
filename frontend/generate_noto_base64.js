...
const outputPath = path.join(__dirname, 'static', 'fonts', 'NotoSansArabic-Regular-normal.js');
...
try {
  ...
  console.log('NotoSansArabic-Regular font base64 generated successfully at:', outputPath);
} catch (error) {
